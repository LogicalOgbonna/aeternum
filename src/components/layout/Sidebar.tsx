...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 h-screen w-64 bg-(--color-surface) border-r border-(--color-border) flex flex-col z-40">
      {/* Logo */}
      <Link href="/" className="block p-6 border-b border-(--color-border) hover:bg-(--color-surface-elevated)/50 transition-colors">
